...
image1 = transform.rescale(color.rgb2gray(io.imread(f'images/{EXAMPLE}1.jpg')),0.25)
image2 = transform.rescale(color.rgb2gray(io.imread(f'images/{EXAMPLE}2.jpg')),0.25)
